...
def main():
    ...
    data = preprocessing.normalize(iris.data)  # Normaliseer de dataset om alle inputs tussen de 0 en de 1 te krijgen.
    ...
    L1 = create_layer(learn_rate, 3, 4, 1)
    L2 = create_layer(learn_rate, 3, 3, 2)
    network = create_network([L1, L2])
